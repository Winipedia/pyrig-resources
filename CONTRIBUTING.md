...
Thanks for considering a contribution to pyrig-resources! Following
...
opening a new issue, search [existing issues](https://github.com/Winipedia/pyrig-resources/issues)
to avoid duplicates.
...
- All checks in [CI](https://github.com/Winipedia/pyrig-resources/actions/workflows/health_check.yml) must pass before merge.
